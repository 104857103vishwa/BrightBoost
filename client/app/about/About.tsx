    ...
    <div className="text-black dark:text-white">
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than brightboost, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of brightboost, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created brightboost &ndash; to provide new programmers
          ...
          <br />
          <br />
          At brightboost, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But brightboost is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With brightboost by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the brightboost family today and let&apos;s
        ...
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of brightboost
        </h5>
        <br />
        <br />
        <br />
